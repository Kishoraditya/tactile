    ...
    return (
        <div className="max-w-2xl mx-auto p-6 space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold">⚙️ {t('settings')}</h1>
                <Link href="/dashboard"><Button variant="ghost">← {t('back')}</Button></Link>
            </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t('audioFeedback')}</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="font-medium">{t('voiceInstructions')}</p>
                            <p className="text-sm text-gray-500">{t('voiceInstructionsDesc')}</p>
                        </div>
                        <button
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="font-medium">{t('vibrationFeedback')}</p>
                            <p className="text-sm text-gray-500">{t('vibrationFeedbackDesc')}</p>
                        </div>
                        <button
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="font-medium">{t('backgroundMusic')}</p>
                            <p className="text-sm text-gray-500">{t('backgroundMusicDesc')}</p>
                        </div>
                        <button
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-sm text-gray-400 mt-2">{t('versionDesc')}</p>
                </CardContent>
            </Card>
